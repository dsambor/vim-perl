...
syn keyword perlConditional		switch 
if exists("perl_fold") && exists("perl_fold_blocks")
...
syn keyword perlOperator		defined undef and or not bless ref eq ne gt lt ge le cmp not and or xor err
...
syn match  perlOperator "\(=>\)" "" contained
syn match  perlOperator "\(->\)" "" contained
syn match  perlOperator "\(==\)" "" contained
syn match  perlOperator "\(<=\)" "" contained
syn match  perlOperator "\(>=\)" "" contained
...
syn match  perlSemiCol "\(;\)" "" contained
syn match  perlDivisors "\({\)" "" contained
syn match  perlDivisors "\(}\)" "" contained
syn match  perlDivisors "\((\)" "" contained
syn match  perlDivisors "\()\)" "" contained
syn match  perlDivisors "\(\[\)" "" contained
syn match  perlDivisors "\(\]\)" "" contained
syn match  perlDivisors "\(,\)" "" contained
syn match  perlArr      "\(@\)" "" contained
syn match  perlArrSpec  "\(@_\)" "" contained
...
if version >= 508 || !exists("did_perl_syn_inits")
  ...
  HiLink perlSemiCol		perlSemiCol
  HiLink perlDivisors		perlDivisors
  HiLink perlArrSpec		perlArrSpec
  HiLink perlArr		perlArr
